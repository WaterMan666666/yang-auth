...
public abstract class ResponseTypeProcessor implements Processor<ResponseType> {
     ...
     * 处理登录后得情况
     */
    public abstract void processAuthenticate(AuthorizeDTO authorizeDTO, AppClientDTO appClientDTO);
    /**
     * 处理未登录时得情况
     */
    public abstract void processUnauthenticate(AuthorizeDTO authorizeDTO, AppClientDTO appClientDTO);
